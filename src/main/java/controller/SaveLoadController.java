...
public class SaveLoadController {
    ...
    public void initialize() {
        currentPlayer = sessionManager.getCurrentPlayer();
    ...
    private void onLoadButtonClick() {
        ...
        try {
            ...
            // 更新会话状态
            sessionManager.setCurrentPlayer(loadedPlayer);
            if (loadedPlayer.hasPets()) {
                sessionManager.setCurrentPokemon(loadedPlayer.getPets().get(0));
            }
            ...
            try {
                ...
                if (playerIdStr != null) {
                    ...
                    if (currentPlayer != null && currentPlayer.getId() == playerId) {
                        sessionManager.setCurrentPlayer(null);
                        currentPlayer = null;
                    }
